...
export const HOTELS = [
  {
    ...
    roomTypes: [
      { type: 'Superior Room', price: '$465' },
      { type: 'Deluxe Room', price: '$510' },
      { type: 'Executive Room', price: '$595' },
      { type: 'Junior Suite', price: '$1,100' },
    ],
  },
  {
    id: 'movenpick',
    ...
    roomTypes: [
      { type: 'Deluxe Room', price: '$400' },
      { type: 'Executive Room', price: '$450' },
    ],
  },
  {
    id: 'alisa',
  ...
  },
  {
    ...
    roomTypes: [
      { type: 'Deluxe Room', price: '$380' },
      { type: 'Club Room', price: '$450' },
    ],
  },
  {
    id: 'labadi',
    ...
    roomTypes: [
      { type: 'Superior Room', price: '$300' },
      { type: 'Luxury Room', price: '$340' },
      { type: 'Superior Suite', price: '$650' },
      { type: 'Executive Suite', price: '$850' },
      { type: 'Presidential Suite', price: '$2,500' },
    ],
  },
  {
    id: 'pelican',
    ...
    roomTypes: [
      { type: 'Standard Room', price: '$245' },
      { type: 'Deluxe Room', price: '$295' },
      { type: 'Junior Suite', price: '$345' },
      { type: 'Premier Suite', price: '$395' },
      { type: 'Executive Suite', price: '$445' },
    ],
  },
  {
    id: 'la-villa',
    ...
    roomTypes: [
      { type: 'Standard Room', price: '$185' },
      { type: 'Superior Room', price: '$215' },
      { type: 'One Bedroom Chalet', price: '$245' },
    ],
  },
  {
    id: 'lancaster',
  ...
  },
  {
    ...
    roomTypes: [
      { type: 'Queen Room', price: '$280' },
      { type: 'Deluxe Queen Room', price: '$330' },
    ],
  },
]
